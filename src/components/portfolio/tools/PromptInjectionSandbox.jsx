...
export default function PromptInjectionSandbox() {
  ...
  return (
    <div>
      <div className="rounded-lg border border-gold/20 bg-noir/60 px-4 py-3">
      ...
      <div className="mt-4 flex h-64 flex-col gap-3 overflow-y-auto rounded-lg border border-gold/15 bg-noir/40 p-4">
        {history.length === 0 && (
      ...
      <div className="mt-4 flex gap-3">
        <input
          ...
          className="flex-1 rounded-lg border border-gold/20 bg-noir/60 px-4 py-3 text-cream outline-none focus:border-gold/60"
        />
        <button
          onClick={handleSend}
          className="inline-flex items-center gap-2 rounded-lg bg-gold px-5 py-2.5 text-sm font-semibold text-noir hover:opacity-90"
        >
          <Send className="h-4 w-4" /> Send
        </button>
      </div>

      <div className="mt-4 flex flex-wrap items-center gap-3 rounded-lg border border-gold/20 bg-noir/40 px-4 py-3 text-sm text-cream/80">
