...
export default function Quiz({ questions }) {
  ...
  if (done) {
    return (
      <div className="flex flex-col items-center gap-4 rounded-lg border border-gold/20 bg-noir/40 px-6 py-10 text-center">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg border border-gold/40 px-5 py-2.5 text-sm font-semibold text-gold hover:bg-gold/10"
        >
  ...
  return (
    <div>
      ...
      {selected !== null && (
        <div className="mt-4 rounded-lg border border-rose-dusty/25 bg-rose-dusty/5 px-4 py-3 text-sm text-cream/80">
          💡 {q.explanation}
        </div>
      )}
      ...
      {selected !== null && (
        <button
          onClick={handleNext}
          className="mt-5 inline-flex items-center gap-2 rounded-lg bg-gold px-5 py-2.5 text-sm font-semibold text-noir hover:opacity-90"
        >
