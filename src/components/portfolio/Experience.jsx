      ...
      <div className="relative mt-16 pl-8 sm:pl-12">
        ...
        <div className="space-y-14">
          {JOBS.map((job, i) => (
            ...
            >
              <span className="absolute -left-8 top-1.5 h-3.5 w-3.5 rounded-lg border border-gold bg-noir transition-all duration-300 group-hover:bg-gold sm:-left-12" />
              ...
              <ul className="mt-4 space-y-2">
                {job.points.map((p, j) => (
                  <li key={j} className="flex gap-3 text-cream/70">
                    <span className="mt-2 h-1 w-1 shrink-0 rounded-lg bg-gold" />
