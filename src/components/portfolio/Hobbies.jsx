      ...
      <div className="mt-14 grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-5">
        {HOBBIES.map((h, i) => (
          <motion.div
            ...
            className="group relative flex aspect-square flex-col items-center justify-center gap-3 overflow-hidden rounded-2xl border border-cream/25 bg-white/40 text-center transition-all duration-300 hover:scale-105 hover:border-gold/50"
          >
            {h.photo ? (
              <>
