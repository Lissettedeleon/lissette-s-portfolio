      ...
      <div className="mt-14 grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-5">
        {HOBBIES.map((h, i) => (
          <motion.div
            ...
            className="group relative flex aspect-square flex-col items-end justify-end overflow-hidden rounded-2xl border border-gold/15 bg-cream/[0.02] transition-all duration-300 hover:scale-105 hover:border-gold/50 hover:shadow-[0_0_30px_rgba(212,168,83,0.18)]"
          >
